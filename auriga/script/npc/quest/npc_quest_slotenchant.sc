...
// モロクマップ座標修正 / アラブルレム 更新
// 2014/07/22 成功率アップデート適用 C = 40% B = 35% A = 35% S = 25% SS = 20%
// 2026/05/12 アラブルレム アイテム追加 スクリプト改修実施
...
prontera.gat,115,191,6	script	トンノ#34589	555,{
...
prt_in.gat,33,70,4	duplicate(セヤブルレム#slot)	セヤブルレム	84
...
-	script	レアブルレム#slot	86,{
	...
	case 1:
		...
		next;
		if('@equip$ == "武器") {
			switch(select("裂けた大地の書[0]","荒れ狂う波の書[0]","乾いてる風の書[0]","燃える太陽の書[0]")) {
			case 1: //裂けた大地の書
				set '@delid,1554;
				set '@getid,1569;
				set '@need,1010;
			...
			switch(select("装飾用ひまわり[0]","学者帽[0]","大きなリボン[0]","学生帽[0]")) {
			case 1: //装飾用ひまわり
				set '@delid,2253;
				set '@getid,5351;
				set '@need,999;
	...
	case 2:
		...
		next;
		if('@equip$ == "武器") {
			switch(select("オーキッシュアックス[0]","シミター[2]","スパイク[0]")) {
			case 1: //オーキッシュアックス
				set '@delid,1304;
				set '@getid,1309;
				set '@need,984;
	...
	case 3:
		...
		next;
		if('@equip$ == "武器") {
			switch(select("ドラゴンキラー[0]","尖ってるいばらのカタール[0]","爆炎のカタール[0]","冷たい氷柱のカタール[0]","疾風のカタール[0]","ゴールデンメイス[1]","琵琶[0]","女王の鞭[0]","妖怪の槍[0]","ゲイボルグ[0]","シュバイチェルサーベル[0]")) {
			case 1: //ドラゴンキラー
				set '@delid,13001;
				set '@getid,13030;
				set '@need,984;
			...
			switch(select("海賊の頭巾[0]","黒革のブーツ[0]","特殊忍者スーツ[0]")) {
			case 1: //海賊の頭巾
				set '@delid,2287;
				set '@getid,5350;
				set '@need,985;
	...
	case 4:
		...
		next;
		if('@equip$ == "武器") {
			switch(select("ゼピュロス[0]","メイルブレイカー[0]","ドラゴンスレイヤー[0]","ソードブレイカー[0]","アサシンダガー[0]","グランドクロス[0]","エクスキューショナー[0]")) {
			case 1: //ゼピュロス
				set '@delid,1468;
				set '@getid,1481;
				setarray '@need,984,999;
			...
			switch(select("マジックコート[0]","ホーリーローブ[0]","神の使者[0]","ランニングシャツ[0]","ブリーフ[0]")) {
			case 1: //マジックコート
				set '@delid,2334;
				set '@getid,2372;
				set '@need,985;
...
morocc.gat,270,247,3	duplicate(レアブルレム#slot)	レアブルレム	86
payon.gat,236,199,3	duplicate(レアブルレム#slot)	レアブルレム	86
prt_in.gat,244,169,5	duplicate(レアブルレム#slot)	レアブルレム	86
//==================================================
// プロブルレム
//==================================================
	...
	case 1:
		...
		switch('@class) {
			case 1:	//C級
				...
				mes "C級のどの防具にしますか？";
				next;
				switch(select("ゴヴニュの軍靴[0]","マグニキャップ[0]","フレイシューズ[0]","駆魔の聖書[0]","ヴェール[0]","イカロスの羽[0]","名射手のスカーフ[0]","足鎖[0]","やめる")) {
					case 1:	//ゴヴニュの軍靴
						set '@delid,2419;
						set '@getid,2493;
						set '@need,999;
			...
			case 2:	//B級
				...
				mes "B級のどの防具にしますか？";
				next;
				switch(select("シャドウウォーカー[0]","ぼろマント[0]","クリティカルリング[0]","お金を失った者の心[0]","銀の懐中時計[0]","ゴヴニュの兜[0]","モリガンのヘルム[0]","真紅の脚絆[0]","ゴヴニュの鎧[0]","サバイバルマント[0]","スプリントリング[0]","やめる")) {
					case 1:	//シャドウウォーカー
						set '@delid,2426;
						set '@getid,2486;
						set '@need,985;
			...
			case 3:	//A級
				...
				mes "A級のどの防具にしますか？";
				next;
				switch(select("ヴィダルのブーツ[0]","セフィロトシューズ[0]","モリガンのベルト[0]","モルフェウスの腕輪[0]","ゴヴニュの肩飾り[0]","ウェディングドレス[0]","モルフェウスのショール[0]","カーズドスター[0]","紳士服[0]","血塗られた鉄球[0]","スピリチュアルリング[0]","やめる")) {
					case 1:	//ヴィダルのブーツ
						set '@delid,2418;
						set '@getid,2489;
						set '@need,985;
			...
			case 4:	//S級
				...
				mes "S級のどの防具にしますか？";
				next;
				switch(select("モリガンのペンダント[0]","モルフェウスの指輪[0]","ガラスの靴[0]","エベシ嵐のうねり[0]","クレイトス大地の裂け目[0]","シャピニハ海の叫び[0]","ルシウス火山の激しさ[0]","ルーンブーツ[0]","忍の腰帯[0]","暗殺者の靴[0]","漁師の靴[0]","昆虫採集家の靴[0]","退魔の靴[0]","庭師の靴[0]","墓守の靴[0]","堕天使の靴[0]","屠竜の靴[0]","狩人の靴[0]","機工士の靴[0]","ヴェスパーコア1[0]","ヴェスパーコア2[0]","ヴェスパーコア3[0]","ヴェスパーコア4[0]","ヒュッケの黒い尻尾[0]","ヒュッケの黒い猫耳[0]","メディカルブーツ[0]","大型マジェスティックゴート[0]","大型オークヒーローの兜[0]","やめる")) {
					case 1:	//モリガンのペンダント
						set '@delid,2651;
						set '@getid,2901;
						set '@need,6223;
			...
			case 5:	//SS級
				...
				mes "SS級のどの防具にしますか？";
				next;
				switch(select("ヴァルハラアイドル[0]","グラス[0]","サングラス[0]","バンカーシールド[0]","やめる")) {
					case 1:	//ヴァルハラアイドル
						set '@delid,19109;
						set '@getid,19110;
						set '@need,6580;
...
prontera.gat,79,104,6	script	アラブルレム	97,{
	...
	case 1:
		...
		if ('@class == 1) { // C級
			set '@class$, "C";
			setarray '@pay_items[1], 1615, 1124, 1629, 1133, 1131, 1625, 1148, 1306, 1557, 1730, 1731, 1732, 1733, 1305, 1414;
			setarray '@target_items[1], 1662, 13437, 1675, 13435, 13436, 1666, 13446, 1324, 28603, 18137, 18138, 18139, 18140, 1300, 1449;
			setarray '@cost_id[1], 999, 999, 999, 999, 999, 999, 999, 999, 999, 999, 999, 999, 999, 999, 999;
			setarray '@cost_num[1], 30, 30, 30, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50;
			setarray '@Zeny[1], 100000, 100000, 100000, 200000, 200000, 200000, 200000, 200000, 200000, 200000, 200000, 200000, 200000, 200000, 200000;
			set '@success, 40;
		} 
		else if ('@class == 2) { // B級
			set '@class$, "B";
			setarray '@pay_items[1], 1541, 1559, 1263, 1260, 13318, 13319, 13320, 1483, 13421, 1242, 13039, 1590, 1385, 1469, 1384;
			setarray '@target_items[1], 16022, 1589, 28003, 28004, 13324, 13325, 13326, 26000, 13459, 13073, 13082, 1598, 1397, 26002, 28114;
			setarray '@cost_id[1], 984, 984, 984, 984, 984, 984, 984, 984, 984, 984, 984, 984, 984, 984, 984;
			setarray '@cost_num[1], 3, 3, 3, 3, 3, 3, 3, 3, 3, 5, 5, 5, 10, 3, 3;
			setarray '@Zeny[1], 300000, 300000, 300000, 300000, 300000, 300000, 300000, 400000, 400000, 400000, 400000, 400000, 500000, 400000, 400000;
			set '@success, 35;
		}
		else if ('@class == 3) { // A級
			set '@class$, "A";
			setarray '@pay_items[1], 1648, 1269, 1421, 13034, 1271, 2001, 1626, 1318, 1471, 1649, 1833, 1529, 1188;
			setarray '@target_items[1], 1663, 1297, 1440, 28704, 1295, 2017, 1665, 1321, 1497, 1679, 1841, 16052, 21024;
			setarray '@cost_id[1], 6224, 6224, 6224, 6224, 6224, 6224, 6224, 6224, 6224, 6224, 6224, 6224, 6224;
			setarray '@cost_num[1], 5, 5, 5, 5, 10, 10, 10, 10, 10, 10, 10, 10, 10;
			setarray '@Zeny[1], 700000, 700000, 700000, 700000, 800000, 800000, 800000, 800000, 800000, 800000, 800000, 800000, 800000;
			set '@success, 30;
		}
		else if ('@class == 4) { // S級
			set '@class$, "S";
			setarray '@pay_items[1], 1164, 1191, 1527, 1140, 1737, 1138, 1636, 1734, 13438, 13028, 1137, 1548;
			setarray '@target_items[1], 21003, 21004, 16024, 13447, 18129, 13453, 1664, 18115, 13448, 28716, 13463, 16056;
			setarray '@cost_id[1], 6224, 6224, 6224, 6224, 6224, 6224, 6224, 6224, 6224, 6224, 6224, 6224;
			setarray '@cost_num[1], 15, 15, 15, 15, 15, 15, 20, 20, 20, 15, 15, 20;
			setarray '@Zeny[1], 1000000, 1000000, 1000000, 1000000, 1000000, 1000000, 2000000, 2000000, 2000000, 1000000, 1000000, 2000000;
			set '@success, 25;
		}

		// メニューの動的作成
		cleararray @name$[0], "", 128;
		set '@count, getarraysize('@pay_items) - 1;
		for (set '@i, 1; '@i <= '@count; set '@i, '@i + 1) {
			// 現在のスロット数を取得
			set '@pay_slot, getiteminfo('@pay_items['@i], 10);
			// リスト表示用： 名前 [スロット数]
			set @name$['@i], getitemname('@pay_items['@i]) + " [" + '@pay_slot + "]";
		}

		set @name$['@count + 1], "やめる";
		mes '@npcname$;
		mes "わかりました。";
		mes "" + '@class$ + "級のどの武器にしますか？";
		next;
		set '@s, select(printarray(@name$[1], ":"));
		if ('@s > '@count) {
			mes '@npcname$;
			mes "わかりました。";
			mes "もし興味がわきましたら";
		...
		// 選択された情報を変数へ代入
		set '@delid,   '@pay_items['@s];
		set '@getid,   '@target_items['@s];
		set '@need,    '@cost_id['@s];
		set '@amount,  '@cost_num['@s];
		set '@price,   '@Zeny['@s];
		...
		// ==========================================
		mes '@npcname$;
		mes "^3355FF" + getitemname('@delid) + "[" + '@s1 + "]^000000ですね。";
		mes "ではご確認します。";
		mes " ";
		mes "まず、手数料として^3355FF" + '@price + "Zeny^000000と";
		mes "^3355FF" + getitemname('@need) + "^000000を^3355FF" + '@amount + "個^000000いただきます。";
		...
		// 所持チェック
		if (countitem('@delid) < 1 || countitem('@need) < '@amount || Zeny < '@price) {
			mes '@npcname$; mes "材料かお金が足りませんよ？"; close;
		}
