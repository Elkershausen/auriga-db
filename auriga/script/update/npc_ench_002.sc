...
prontera.gat,170,125,4	script	エンチャントテスト	70,{
	mes "[" +strnpcinfo(1)+ "]";
	mes "対象装備のIDを入力";
	next;
	input '@item;
...
prontera.gat,172,125,4	script	時間表示	553,{

	mes "[" +strnpcinfo(1)+ "]";
	mes ""+gettime(7)+"年";
	mes ""+gettime(6)+"月";
	mes ""+gettime(5)+"日";
	mes ""+gettime(4)+"曜日 0:日曜 - 6:土曜";
	mes ""+gettime(3)+"時";
	mes ""+gettime(2)+"分";
	mes ""+gettime(1)+"秒";
...
prontera.gat,174,125,4	script	setarray	553,{
	setarray '@test[0],8,16,32,64,128;
	mes "[" +strnpcinfo(1)+ "]";
	mes "setarray : "+'@test[0]+"";
	mes "setarray : "+'@test[1]+"";
	mes "setarray : "+'@test[2]+"";
...
prontera.gat,158,150,4	script	賢い老女	78,{
	mes "[賢い老女]";
	mes "いい天気だね、若いの。";
