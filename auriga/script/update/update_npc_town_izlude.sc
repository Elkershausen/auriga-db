...
izlude.gat,202,171,3	script	協会会員	105,{
	...
	if(select("行く","立ち去る")==2)
		close;
	warp "izlude_in.gat",151,127;
	end;
OnInit:
	waitingroom "剣士協会はこちらへ",0;
	end;
}